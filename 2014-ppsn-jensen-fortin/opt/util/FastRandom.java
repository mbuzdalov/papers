...
public final class FastRandom extends Random implements Serializable {
     ...
     */
    public final FastRandom makeCopy() {
     ...
     *
     * This and the given generators will, after the method returns, produce the same random sequence
     * until either of them is restarted somehow.
     *
     * @param source the RNG to copy the state from.
     */
    public final void copyStateFrom(FastRandom source) {
        this.c = source.c;
        this.idx = source.idx;
    ...
    public final double nextGaussianSlow() {
